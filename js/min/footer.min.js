        ...
        <div class="grid md:grid-cols-3 gap-10 items-start pb-12 border-b border-divider">
          <div>
            ...
            <div class="flex flex-wrap items-center justify-center gap-x-4 gap-y-3 rounded-lg p-3">
              ...
              <img src="/images/site/cert-tuv-sud.webp" alt="T\xDCV S\xDCD" loading="lazy" decoding="async" class="h-14 md:h-10 lg:h-16 w-auto flex-none" />
...
`,(function(){const t=document.getElementById("whatsapp-qr");if(!t)return;const n=()=>{const s=window.qrcode(0,"M");s.addData(SITE.contact.whatsapp),s.make(),t.innerHTML=s.createSvgTag({scalable:!0});const e=t.querySelector("svg");e&&(e.style.width="100%",e.style.height="100%",e.style.display="block")};if(window.qrcode){n();return}const a=document.createElement("script");a.src="https://cdn.jsdelivr.net/npm/qrcode-generator@1.4.4/qrcode.min.js",a.onload=n,document.head.appendChild(a)})();
